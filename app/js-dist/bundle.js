...
/***/ function(module, exports, __webpack_require__) {
	...
	var iBox = __webpack_require__(197);
	...
	// Declare routes
	var routes = (
	  React.createElement(Route, {handler: iBox, path: "/:_id"}
	  )
	);module.exports = {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ItemList = __webpack_require__(199);
	var ItemForm = __webpack_require__(201);
	var Recalculate = __webpack_require__(202);
	
	
	// Component
	var iBox = React.createClass({displayName: "iBox",
	    getInitialState: function() {
	    return {data: [],meta:''};
	  },
	  ...
	  render: function() {
	    return (
	      ...
	      React.createElement("div", {className: "iBox"}, 
	        React.createElement(Title, {meta: this.state.meta}), 
	        React.createElement(ItemList, {data: this.state.data, onCommentSubmit: this.handleCommentSubmit}), 
	        React.createElement(Recalculate, {data: this.state.data}), 
	        React.createElement(ItemForm, {onCommentSubmit: this.handleCommentSubmit}), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var Item = __webpack_require__(200);
	...
	this.trigger=false;
	 ...
	 handleClick: function(i) {
	  ...
	  render: function() {
	      ...
	      return (
	        React.createElement(Item, {onClick: boundClick, key: i, onChange: inputChange, onBlur: blurChange, author: item.key}, 
	         item.value
	      )
	      );
	    }.bind(this));
	  ...
	  render: function() {
	    return (
	      React.createElement("div", {onClick: this.props.onClick, className: "item"}, 
	        React.createElement("div", {className: "itemAuthor"}, 
	          this.props.author
	        ), 
	        React.createElement("form", null, 
	        React.createElement("input", {value: this.props.children, onChange: this.onInputChange, onBlur: this.onBlur, ref: "changevalue"})
	        )
	      )
	    );
	  }
	  ...
	  render: function() {
	    return (
	       React.createElement("form", {className: "itemForm", onSubmit: this.handleSubmit}, 
	        React.createElement("input", {type: "text", placeholder: "id........", ref: "id"}), 
	        React.createElement("input", {type: "number", placeholder: "value......", ref: "value"}), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Recalculate = React.createClass({displayName: "Recalculate",
	  render: function() {
	    ...
	    return (
	      React.createElement("div", {className: "recalculate"}, 
